...
import { HeartIcon as HeartIconSolid, CheckBadgeIcon, StarIcon, EyeIcon } from '@heroicons/react/24/solid'
	...
	return (
		...
		>
			<div className="relative aspect-[4/3] w-full overflow-hidden">
				...
				<button
					onClick={toggleFav}
					className="absolute top-2 right-2 inline-flex h-9 w-9 items-center justify-center rounded-full bg-white/90 text-gray-600 backdrop-blur hover:text-red-500 hover:bg-white transition shadow-sm"
