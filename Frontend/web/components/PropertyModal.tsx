...
const PropertyModal: React.FC<PropertyModalProps> = ({ propertyId, isOpen, onClose }) => {
  ...
  const handleContact = () => {
    if (!user) {
      ...
      router.push('/register?type=user&redirectTo=/');
      onClose();
    } else {
      // Si hay usuario, mostrar información de contacto (implementar después)
      alert('Mostrar información de contacto');
    }
  };
  ...
  const handleWhatsApp = () => {
    if (!user) {
      ...
      // Si hay usuario, abrir WhatsApp (implementar después)
                  ...
                  <div className="border-t pt-6">
                    ...
                    <div className="flex gap-4">
                      ...
                      >
                        ...
                        {user ? 'Contactar' : 'Registrarse para Contactar'}
                      </button>
                      <button 
