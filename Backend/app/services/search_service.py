...
class SearchService:
    ...
    def _listing_to_dict(self, listing: Listing) -> Dict[str, Any]:
        ...
        return {
            ...
            'airbnb_score': listing.airbnb_score,
            'airbnb_eligible': listing.airbnb_eligible,
            'airbnb_opted_out': listing.airbnb_opted_out,
            'smoking_allowed': listing.smoking_allowed,
            'deposit_required': listing.deposit_required,
            'deposit_amount': float(listing.deposit_amount) if listing.deposit_amount else None,
            'minimum_stay_nights': listing.minimum_stay_nights,
            'maximum_stay_nights': listing.maximum_stay_nights,
            'check_in_time': listing.check_in_time,
            'check_out_time': listing.check_out_time,
            'max_guests': listing.max_guests,
            'cleaning_included': listing.cleaning_included,
            'cleaning_fee': float(listing.cleaning_fee) if listing.cleaning_fee else None,
